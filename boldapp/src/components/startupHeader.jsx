...
const StartupHeader = ({ name, logo, coverPhoto }) => {
    ...
    return (
        <div>
            <a href={url}>
                {coverPhoto && <div className='flex justify-center items-center bg-cover bg-center bg-no-repeat h-[15rem]  bg-lightBackground ' style={{ backgroundImage: `url(${coverPhoto})` }} />}
