...
const RegisterStartupForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const founderUrl = 'https://long-tan-firefly-tam.cyclic.app/userByEmail/' + user.email;
            ...
            const response = await fetch('https://long-tan-firefly-tam.cyclic.app/startup/create', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
